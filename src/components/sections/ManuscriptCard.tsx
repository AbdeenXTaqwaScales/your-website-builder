...
export const ManuscriptCard: React.FC<ManuscriptCardProps> = ({
  ...
  return (
    <Link
      ...
      to={href}
      className={`
        group relative block p-6 md:p-8 rounded-2xl border-2 transition-all duration-500 min-h-[220px] md:min-h-[260px]
    ...
    >
      ...
      <h3 className={`font-display text-xl md:text-2xl font-bold mb-3 ${colors.title}`}>{title}</h3>
